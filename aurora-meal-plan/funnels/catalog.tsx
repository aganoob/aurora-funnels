...
export const auroraMealPlan = defineFunnel({ id: "aurora-meal-plan", productId: "aurora-meal-plan", domains: ["aurora-meal-plan.localhost"], defaultOffer: "annual", screens: [defineScreen({ id: "welcome", type: "landing", component: Welcome }), defineScreen({ id: "paywall", type: "paywall", component: Paywall, conversion: "subscription_started" }), defineScreen({ id: "success", type: "success", component: Success })] });
